...
function getHotels(){
	...
	.then(result =>  {
        ...
        console.log(result.data[0].hotel.longitude);
...
/*fetch("https://maps.googleapis.com/maps/api/js?key=AIzaSyAcgKWpfGwFo7jCPzrsAfjxoMlLOcE9m0c&callback=initMap&libraries=&v=weekly")
